...
<script src="resources/js/pagar.js?5cffb14a4e04b"></script>
			...
			<div class="container">
				...
				<div class="row justify-content-around">
					<div class=col-6>
						<div class="row justify-content-center">
							<div class="col-lg-10">
								...
								<form id="form-boleta" action="" novalidate="novalidate" method="post">
									<div class="row">
										<div class="col-md-6">
											<div class="fila">
												<p>
										...
										<input type="hidden" id="identificador_aux" name="identificador_aux" value="${identificador}"
											style="display: none"   />
									</div>
								</form>
							</div>
							...
							<c:forEach items="${cards}" var="card">
								<div class="card" style="margin-top: 20px;margin-right: 10px;">
									<div class="row">
										...
										<div class="col-md-4">
											<img class="card-img-top"
												src="resources/images/${card.cardType}.png"
												alt="Card image cap">
										</div>
										<div class="col-md-6">
											<div class="card-body">
												<h5 class="card-title">Authortization Code:
													${card.authorizationCode}</h5>
					...
					<div class=col-6>
						<div class="row justify-content-center">
							<div class="row">
								<div class="col-md-6">
									<div class="fila">
										<p>
											<label for="email">Producto 1</label>
										</p>
										<input type="text" id="producto1" name="producto1"
											class="form-control" placeholder="">
									</div>
								</div>
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="fila">
										<p>
											<label for="email">Producto 2</label>
										</p>
										<input type="text" id="producto2" name="producto2"
											class="form-control" placeholder="">
									</div>
								</div>
								<div class="col-md-6">
						...
						<button id="pagar" class="btn_purple">PAGAR</button>
						<div id="textopagado1">
						</div>
						<div id="textopagado2">
						</div>
