...
public class ConsultTransactionRequestModel {
	...
	public String toString() {
		return "ConsultTransactionRequestModel [id_company=" + id_company + ", credential_id_company="
				+ credential_id_company + ", id_client=" + id_client + ", email=" + email + ", transaction_order="
				+ transaction_order + "]";
	}
